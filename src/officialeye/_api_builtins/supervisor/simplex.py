...
class SimplexSupervisor(Supervisor):

    SUPERVISOR_ID = "simplex"

    def __init__(self, config_dict: ConfigDict, /):
        super().__init__(SimplexSupervisor.SUPERVISOR_ID, config_dict)

        # setup configuration
        self._min_match_factor = 0.1
        self._max_transformation_error = 5
        self._z3_timeout = 2500
